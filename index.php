...
<body>
    ...
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" id='confirm' onclick="">Continuar</button>
  ...
  <script>
    ...
    function validateForm() {
      ...
      if (idNo === '' || name === '' || contact === '' || email === '' || address === '') {
    ...
    document.getElementById('manage-student').addEventListener('submit', validateForm);
  </script>
